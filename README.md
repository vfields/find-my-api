...
<p>
<b>Challenges:</b><br>
In the same vein, cracking the logic for a multi-input search and figuring out <code>useRef</code> proved to be the most challenging pieces of the project. I also feel I could have made smaller, more reusable search components within my advanced search display.
